...
public:
    ...
    bool SetTextAndHighlight(wxString Text, EntityTreeModelNode* Root);
...
private:
    ...
    // Tracking node for current modifications.
    EntityTreeModelNode *m_CurrentNode;
    wxString m_PreModification;
